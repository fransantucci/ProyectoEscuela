Public Class frmProfMod
    ...
    Private Sub btnRegistrarProfesor_Click(sender As Object, e As EventArgs) Handles btnRegistrarProfesor.Click
        ...
        If Validar() = 1 Then
            ...
            cadenaSQL = "Update Profesores set direccion = '" & txtDireccion.Text & "', email = '" & txtEmail.Text & "', telefono = '" & txtTelefono.Text & "', est_civil = '" & cmbEstCivil.SelectedItem & "', cod_titulo = '" & cmbTitulo.SelectedValue & "', cod_Acceso = '" & cmbCodAcceso.SelectedValue & "', contrasenia = '" & txtPass.Text & "' where nro_legajo_p = " & txtNroLegajo.Text
